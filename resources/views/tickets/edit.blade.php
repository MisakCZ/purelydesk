...
@section('content')
    <div class="page-head">
        <div class="page-head-bar">
            ...
            <a class="button button-secondary ticket-form-action" href="{{ route('tickets.show', $ticket) }}">
                ...
                <span>{{ __('tickets.edit.actions.back') }}</span>
            </a>
        </div>
    </div>
            ...
            <form class="form-layout" method="post" action="{{ route('tickets.update', $ticket) }}">
                ...
                <div class="actions">
                    <button class="button button-primary ticket-form-action" type="submit">
                        ...
                        <span>{{ __('tickets.edit.actions.save') }}</span>
                    </button>
                    <a class="button button-secondary ticket-form-action" href="{{ route('tickets.show', $ticket) }}">
                        <span class="ticket-form-action-icon" aria-hidden="true">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <span>{{ __('tickets.edit.actions.cancel') }}</span>
                    </a>
                </div>
            </form>
        </section>
