...
return [
    'ticket' => [
        ...
        'subject_events' => [
            'created' => ':name created a ticket.',
            'ticket_updated' => ':name updated the ticket.',
            'public_comment' => ':name added a comment.',
            'assignee_changed' => ':name changed the assignee.',
            'status_changed' => ':name changed the status.',
            'resolved' => ':name marked the ticket as resolved.',
            'problem_persists' => ':name reported that the problem persists.',
            'closed' => ':name closed the ticket.',
            'expected_resolution_changed' => ':name changed the expected resolution date.',
            'expected_resolution_due_soon' => ':name is reminding you about an upcoming deadline.',
            'expected_resolution_overdue' => ':name is reminding you about an overdue deadline.',
        ],
        'lines' => [
        ...
        'descriptions' => [
            ...
            'ticket_updated' => 'The ticket was updated in the helpdesk.',
