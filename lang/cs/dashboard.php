...
return [
    ...
    'summary' => [
        ...
        'waiting_for_user' => 'Čekají na uživatele',
        'without_expected_resolution' => 'Bez termínu',
        'due_soon_or_overdue' => 'Po termínu / blíží se termín',
    ],
    'summary_notes' => [
        'new_unassigned_tickets' => 'Otevřené tickety bez řešitele',
        'my_assigned_tickets' => 'Vaše aktivní fronta',
        'due_today' => 'Očekávané vyřešení dnes',
        'due_soon' => 'Do 24 hodin',
        'waiting_for_user' => 'Čeká se na doplnění',
    ],
    'pinned' => [
